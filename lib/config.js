...
const loadConfig = (region,funcname)=>{
    ...
    const zipname = configfile.zipname ? configfile.zipname : default_zipname;
    CONFIG =  {
        ...
        function: funcname ? funcname : configfile.function
    };

    if(typeof(CONFIG.region) === 'undefined' || typeof(CONFIG.function) === 'undefined') {
